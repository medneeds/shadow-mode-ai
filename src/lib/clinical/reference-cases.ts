...
export const referenceCase: ClinicalCaseDefinition = {
  ...
  meta: {
    ...
    subtopic: "Causa metabólica reversível",
    archetype: "altered_mental_status",
    setting: "emergency_department",
    difficulty: "intermediario",
    clinicalSyndrome: "Coma de causa indeterminada no pronto-socorro",
    primaryDiagnosis: "Hipoglicemia grave em diabético em uso de insulina e sulfonilureia",
    ...
    ageGroup: "adult",
    acuity: "critical",
    skills: ["initial_approach", "diagnostic_reasoning", "treatment", "reassessment", "safety"],
    compatibleDurations: ["5", "15", "30"],
    estimatedMinutes: 15,
    review: {
      status: "needs_clinical_review",
      notes: "Caso de referência da Phase 03. Requer validação por médico revisor.",
    },
    keywords: [
      "rebaixamento",
      "inconsciente",
